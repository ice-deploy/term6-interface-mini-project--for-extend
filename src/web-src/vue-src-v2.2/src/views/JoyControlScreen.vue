...
<script>
// Event-touch for mobile(mouseDown,mouseUp not clickEvent) กดค้าง(Joy)
 ...
 *  support 'Event-touch' สำหรับกดติด-ปล่อยดับ
 */
  ...
  methods: {
    ...
    startPing() {
      ...
      this.loopPing = setInterval(() => {
        ...
        console.log("start-> setInterval() -> ping: ", this.$store.getters.getPing);
      }, 1000);
    }
  }
};
